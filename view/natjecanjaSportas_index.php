<?php require_once __SITE_PATH . '/view/_headerSportas.php'; ?>
	...
	<div class="trening-info" id="odbojavanje">
    ...
    document.getElementById("odbrojavanje").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";

    // If the count down is over, write some text 
    if (distance < 0) {
        clearInterval(x);
    document.getElementById("odbrojavanje").innerHTML = "EXPIRED";
    }
  }, 1000);
    });
	</script>
